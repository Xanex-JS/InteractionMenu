...
BadgeColour = {
    [5] = function(Selected) if Selected then return 0, 0, 0, 255 else return 224, 50, 50, 255 end end,
    [21] = function(Selected) if Selected then return 0, 0, 0, 255 else return 224, 50, 50, 255 end end,
    [22] = function(Selected) if Selected then return 0, 0, 0, 255 else return 224, 50, 50, 255   end end,
}
...
function UIResRectangle.New(X, Y, Width, Height, R, G, B, A)
    local _UIResRectangle = {
        ...
        _Colour = {R = tonumber(R) or 0, G = tonumber(G) or 0, B = tonumber(B) or 0, A = tonumber(A) or 255},
    }
...
function DrawRectangle(X, Y, Width, Height, R, G, B, A)
    ...
    X, Y = FormatXWYH(X, Y)
    Width, Height = FormatXWYH(Width, Height)
    DrawRect(X + Width * 0.5, Y + Height * 0.5, Width, Height, tonumber(R) or 0, tonumber(G) or 0, tonumber(B) or 0, tonumber(A) or 255)
end
...
function RenderText(Text, X, Y, Font, Scale, R, G, B, A, Alignment, DropShadow, Outline, WordWrap)
    ...
    SetTextFont(Font or 0)
    SetTextScale(1.0, Scale or 0)
    SetTextColour(R or 0, G or 0, B or 0, A or 255)
